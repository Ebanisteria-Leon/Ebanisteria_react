...
export const TableProducts = () => {
    ...
    let api = helpHttp()
    let url =
        'https://leon-ebanisteria.herokuapp.com/api/producto/?ordering=-idProducto'
    ...
    const cambiarEstadoPromocion = () => {
        ...
        if (
            productoSolo.estadoPromocion === 'false' ||
            productoSolo.estadoPromocion === 'NOP'
        ) {
        ...
        <>
                    ...
                    <form className='formAgregar2' onSubmit={handleSubmit}>
                        ...
                        <div className='txt_field'>
                            <input
                                ...
                                onChange={handleChange}
                            />
                            <label className='labelForm' for='medidasA'>
                                {' '}
                                Medidas del producto (Altura){' '}
                            </label>
                            <span></span>
                        </div>
                        ...
                        <div className='txt_field'>
                            <input
                                ...
                                onChange={handleChange}
                            />
                            <label className='labelForm' for='medidasL'>
                                {' '}
                                Medidas del producto (Largo){' '}
                            </label>
                            <span></span>
                        </div>
                        ...
                        <div className='txt_field'>
                            <input
                                ...
                                onChange={handleChange}
                            />
                            <label className='labelForm' for='medidasAn'>
                                {' '}
                                Medidas del producto (Anchura){' '}
                            </label>
                            <span></span>
                        </div>
                        ...
                        <div className='txt_field'>
                            <input
                                ...
                                id='calificacion'
                                name='calificacion'
                                value={form2.calificacion}
                                required
                                onChange={handleChange}
                            />
                            <label className='labelForm' for='calificacion'>
                                {' '}
            ...
            <div className='overlayPromocion'>
                <div className='containerPromocion'>
                    ...
                    <form
                        className='formCategoria formPromo'
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div className='buttonsTable-actions'>
                                                              <button
                                                                  className='btnAction-table update-products'
                                                              ...
                                                              <button
                                                                  className='btnAction-table delete-products'
                                                                  title='Eliminar Producto'
                                                                  onClick={() =>
                                                                      deleteData(
                                                                          index
